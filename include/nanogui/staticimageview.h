/*
    nanogui/staticimageview.h -- Widget used to display images.
...
/**
 * \class StaticImageView staticimageview.h nanogui/staticimageview.h
 *
 * \brief Widget used to display images.
 */
class NANOGUI_EXPORT StaticImageView : public Widget {
public:
    StaticImageView(Widget* parent, GLuint imageID);
    ~StaticImageView();
